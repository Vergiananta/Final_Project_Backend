...
public class VendorController {
    ...
    @PostMapping
    Vendor saveVendor(@RequestPart MultipartFile videos,@RequestPart MultipartFile file,@RequestPart String vendor) throws IOException {
        return service.saveVendor(videos,file,vendor);
    }
    ...
    @PutMapping
    Vendor updateVendor(@RequestPart MultipartFile videos,@RequestPart MultipartFile file,@RequestPart String vendor) throws IOException {
        return service.updateVendor(videos,file,vendor);
    }
