...
//    @JsonIgnore
    ...
    public Vendor(String name,String username,String password,Gender gender,String company,String email,String address, String video){
        this.name=name;
...
// jika memakai lombok tidak bisa auto generate constructor lebig dari satu
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(id, vendor.id) &&
                ...
                Objects.equals(video, vendor.video);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, name, username, password, gender, company, email, photo, address, statusRequest, video);
    }
