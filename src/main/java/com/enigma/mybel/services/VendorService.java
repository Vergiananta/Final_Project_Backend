...
public interface VendorService {
    Vendor saveVendor(MultipartFile videos, MultipartFile file, String requestBody) throws IOException;
    Vendor saveFormVendor(Vendor vendor);
    Vendor updateVendor(MultipartFile videos, MultipartFile file, String requestBody) throws IOException;
